...
export const GALLERY_ITEMS: GalleryMedia[] = [
  ...
  { id: 'gallery-valentines-new-17', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808492/IMG-20260208-WA0048_fqvvo9.jpg', alt: 'Romantic Gift Set', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines gift' },
  { id: 'gallery-valentines-new-18', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808490/IMG-20260208-WA0046_rsdtri.jpg', alt: 'Valentine Couple Present', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines gift' },
  { id: 'gallery-valentines-new-19', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808490/IMG-20260208-WA0044_yjbred.jpg', alt: 'Handmade Valentine Card', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines card' },
  { id: 'gallery-valentines-new-20', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808489/IMG-20260208-WA0042_fhgran.jpg', alt: 'Valentine Themed Decor', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines decor' },
  { id: 'gallery-valentines-new-21', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808488/IMG-20260208-WA0036_nagi4o.jpg', alt: 'Box of Roses', type: 'image', category: ['valentines', 'gifting'], aiHint: 'roses box' },
  { id: 'gallery-valentines-new-22', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808485/IMG-20260208-WA0034_bdhhpb.jpg', alt: 'Valentine Love Frame', type: 'image', category: ['valentines', 'gifting'], aiHint: 'love frame' },
  { id: 'gallery-valentines-new-23', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808484/IMG-20260208-WA0030_pyng47.jpg', alt: 'Personalized Couple Mug', type: 'image', category: ['valentines', 'gifting'], aiHint: 'couple mug' },
  { id: 'gallery-valentines-new-24', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808482/IMG-20260208-WA0028_bxkxb8.jpg', alt: 'Cute Valentine Gift', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines gift' },
  { id: 'gallery-valentines-new-25', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808482/IMG-20260208-WA0026_hck6uo.jpg', alt: 'Valentine Treat Box', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines box' },
  { id: 'gallery-valentines-new-26', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808482/IMG-20260208-WA0016_tlhjwm.jpg', alt: 'Handcrafted Love Gift', type: 'image', category: ['valentines', 'gifting'], aiHint: 'love gift' },
  { id: 'gallery-valentines-new-27', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808482/IMG-20260208-WA0024_dj57xk.jpg', alt: 'Special Valentine Present', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines present' },
  { id: 'gallery-valentines-new-28', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808480/IMG-20260208-WA0022_dgg2oi.jpg', alt: 'Valentine Gift Idea', type: 'image', category: ['valentines', 'gifting'], aiHint: 'gift idea' },
  { id: 'gallery-valentines-new-29', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808479/IMG-20260208-WA0020_dqlq0n.jpg', alt: 'Unique Valentine Gift', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines gift' },
  { id: 'gallery-valentines-new-30', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808478/IMG-20260208-WA0018_afx3om.jpg', alt: 'Valentine Art Piece', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentine art' },
  { id: 'gallery-valentines-new-31', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808478/IMG-20260208-WA0014_yaikpn.jpg', alt: 'Heartfelt Valentine Gift', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines gift' },
  { id: 'gallery-valentines-new-32', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808476/IMG-20260208-WA0010_yglruq.jpg', alt: 'Thoughtful Valentine Present', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentines present' },
  { id: 'gallery-valentines-new-33', src: 'https://res.cloudinary.com/dsdp8sjkh/image/upload/v1770808476/IMG-20250525-WA0107_s2ru1m.jpg', alt: 'Custom Valentine Frame', type: 'image', category: ['valentines', 'gifting'], aiHint: 'valentine frame' },

        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-lg text-foreground/80 mb-6">
              Discover our exclusive collection of handcrafted gifts and thoughtful hampers. Each one is designed to make this Diwali unforgettable.
            </p>
          ...
          <div className="order-1 md:order-2 flex items-center justify-center">
            <div className="relative w-full max-w-sm aspect-[9/16] rounded-xl overflow-hidden shadow-2xl group">
              <video
